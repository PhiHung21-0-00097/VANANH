...
import "./styles/ServiceBuy.scss";
import { Link } from "react-router-dom";
export default class ServiceBuy extends React.Component {
  render() {
    return (
      <>
        <section
          ...
          <div className="container">
            <div className="row row-title ">
              <div className="col col-body">
                  ...
                  <div className="col col-xxl-9 col-left">
                    <div className="row bg-white">
                      <div className="col col-xxl-6">
                        <div className="row">
                          <img
                            className="img-body img-fluid"
                            src={
                              "https://xenanghelivn.net/wp-content/uploads/2021/11/ac-quy-xe-nang-dien-2.jpg"
                            }
                          ></img>
                        </div>
                        <div className="row">
                        ...
                        <div className="row product-top p-2">
                          ...
                          <div classNameName="row row-list-info">
                            ...
                            <p>
                              ...
                              model thông dụng và lý do tại sao nên chọn ắcquy
                              GS Yuasa.
                            </p>
                          </div>
                ...
                <div className="row  text-center pt-4 mb-4 bg-white">
                  <div className="row row-title ">
                    <h2>Mô tả</h2>
                  </div>
                  <div className="row row-if text-start">
                    <div className="col col-lg-6 col-md-12 col-sm-12 col-left">
                      ...
                      <span>
                        <p>
                          ...
                          hình phẳng, dẹp từ khung lưới và thêm các hạt hóa
                          chất.
                        </p>
                      </span>
                    </div>
                    <div className="col col-bottom-right">
                      ...
                      <span>
                        <p>
                          Bình điện xe nâng đóng vai trò vô cùng quan trọng
                          trong hệ thống nhiên liệu của động cơ thiết bị. Chúng
                          được ví như một chiếc bơm máu đi nuôi dưỡng và cung
                          cấp năng lượng cho các cơ quan, mọi bộ phận của xe để
                          có thể vận hành.
                        </p>
                      </span>
                    </div>
